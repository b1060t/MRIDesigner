...
DefineConstant[
  ...
  modelDim = 3, // default model dimension (2D)
  ...
  NL_tol_abs = 1e0, // absolute tolerance on residual for noninear iterations
...
PostProcessing {
  ...
  { Name Magnetostatics_a; NameOfFormulation Magnetostatics_a;
    Quantity {
      ...
      { Name bz; Value {
          Term { [ -CompZ[{d a}] ]; In Vol_Mag; Jacobian JacVol_Mag; }
        }
      }
      { Name a; Value {
