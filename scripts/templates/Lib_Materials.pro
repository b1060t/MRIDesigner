...
Function{
  ...
  // Steel (1010)
  Materials() += Str[ "Steel1010" ];
  Steel1010_relative_magnetic_permeability = 667.75;
  Steel1010_electric_conductivity = 2e6;
  Steel1010_relative_dielectric_permittivity = 1;
  Steel1010_magnetic_field_list() = {
    0, 122.58, 135.48, 161.29, 206.45, 258.06, 290.32, 361.29, 432.26,
    522.58, 645.16, 774.19, 929.03, 1103.23, 1354.84, 1621.90, 2000.00,
    2335.48, 2825.81, 3387.10, 4064.52, 4903.23, 5877.42, 7096.77, 8535.48,
    10432.26
  } ;
  Steel1010_magnetic_flux_density_list() = {
    0, 0.19, 0.28, 0.38, 0.48, 0.59, 0.69, 0.8, 0.9, 1.0, 1.09, 1.18,
    1.24, 1.3, 1.37, 1.41, 1.465, 1.5, 1.52, 1.54, 1.57, 1.6, 1.62, 1.65,
    1.68, 1.71
  } ;
  Steel1010_elastic_poisson_ratio = 0.29;
  Steel1010_elastic_young_modulus = 200e9;
  Steel1010_mass_density = 7850;
